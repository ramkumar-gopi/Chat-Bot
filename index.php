...
$(document).ready( function () {
  ...
  $(document).ready( function () {
		$('#query button').click( function (e) {
			...
			$.ajax({
			    type: "POST",
			    url: "http://10.10.226.71/query.php",
...
<body>
  <div id="chat" class="col-sm-4">
    ...
    <div class="chat-box" style="display: none;">
      <div class="chat-box-header">BIT-ChatBot<span class="chat-box-toggle"> <i class="material-icons">close</i> </span>
      </div>
      <div class="chat-box-body">
        ...
        <?php if(!isset($_SESSION['s_email'])){?>
          <form id='usr-details' autocomplete="off" name="usr-details"  >
            <div id="cm-msg-0" class="chat-msg user" >
              ...
              <div>
                  <button type="submit" id='gen' name='gen' value='Admission Inquiry'>Admission Inquiry</button>
                   <button type="submit" id='gen' name='gen' value='General Inquiry'>General Inquiry</button>
                 </div>
        ...
        <?php }else { ?>
          ...
          <div class="cm-msg-text">Hello I'm BIT Chat-Bot (beta)</div>
        </div>
